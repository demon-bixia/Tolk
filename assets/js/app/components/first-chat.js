...
<div class="tab-content">
    <% if (conversation.type === 'couple'){ %> <% for (let participant of conversation.participants){ %> <% if (participant.id !== authenticated_contact.id){ %> <% let friend_contact = participant %>
                ...
                <div class="container">
                    <div class="top">
                        <div class="headline" data-conversation='<%= conversation.id %>'><img
                            ...
                            <div><h5><%= friend_contact.first_name %> <%= friend_contact.last_name %></h5>
                ...
                <div class="middle scroll">
                    <div class="container">
                        <ul>
                            ...
                            <li class="<%= message['sender']['user']===friend_contact['user'] ? 'odd' : 'self' %>"><img
            ...
            <div class="utility">
                <div class="container">
                    ...
                    <div class="profile"><p>Profile Info</p><img src="<%= friend_contact.contact_pic %>" alt="">
                        <h4> <%= friend_contact.first_name %> <%= friend_contact.last_name %></h4> <span>Offline</span>
                    </div>
